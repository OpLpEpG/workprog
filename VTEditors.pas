...
type
  ...
  TPropertyData = record
    ...
    XMLAttrib: IXMLNode;      // This value can actually be a date or a number too.
    Changed: Boolean;
  end;
...
begin
  ...
  if S <> Data.XMLAttrib.NodeValue then
  begin
    Data.XMLAttrib.NodeValue := S;
    Data.Changed := True;
    ...
    vtMemo:
      begin
        ...
        begin
          ...
          Parent := Tree;
          Text := Data.XMLAttrib.NodeValue;
          Items.Add(Data.XMLAttrib.NodeValue);
          OnKeyDown := EditKeyDown;
          OnKeyUp := EditKeyUp;
        end;
      end;
